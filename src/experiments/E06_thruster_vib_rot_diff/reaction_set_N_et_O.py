...
def get_species_and_reactions(chamber, altitude):
    ...
    injection_rates = collection_rate * np.array([2e15, comp_data["Q_N2(s-1)"].values[0], comp_data["Q_N(s-1)"].values[0], 1e15, 1e15, 0.0, comp_data["Q_O2(s-1)"].values[0], comp_data["Q_O(s-1)"].values[0], 0.0])
