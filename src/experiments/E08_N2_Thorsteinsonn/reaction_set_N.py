...
from global_model_package.reactions import (Excitation, Ionisation, Dissociation, 
                        ...
                        PressureBalanceFluxToWalls, PressureBalanceFluxToWalls, 
                        GasInjection, ElectronHeatingConstantRFPower, ElectronHeatingConstantAbsorbedPower
                    )
...
def get_species_and_reactions(chamber):
    ...
    initial_state_dict = {
        ...
        "N+": 1e+16,
        "T_e": 3.88314080e+00,
        "T_mono": 1.18264462e-01,
        "T_diato": 1.00254543e-01
    }
    compression_rate = 1.
...
#  ▄▀  ▄▀▄ ▄▀▀   █ █▄ █   █ ██▀ ▄▀▀ ▀█▀ █ ▄▀▄ █▄ █
#  ▀▄█ █▀█ ▄██   █ █ ▀█ ▀▄█ █▄▄ ▀▄▄  █  █ ▀▄▀ █ ▀█
    injection_rates = compression_rate * np.array([0.0, 2.24e19, 0.0, 0.0, 0.0]) #, 1e10, 2e13, 1e15, 1e10] #à revoir
...
#  ██▀ █   ██▀ ▄▀▀ ▀█▀ █▀▄ ▄▀▄ █▄ █   █▄█ ██▀ ▄▀▄ ▀█▀ █ █▄ █ ▄▀    ██▄ ▀▄▀   ▀█▀ █▄█ ██▀   ▄▀▀ ▄▀▄ █ █    
#  █▄▄ █▄▄ █▄▄ ▀▄▄  █  █▀▄ ▀▄▀ █ ▀█   █ █ █▄▄ █▀█  █  █ █ ▀█ ▀▄█   █▄█  █     █  █ █ █▄▄   ▀▄▄ ▀▄▀ █ █▄▄  
    #electron_heating = ElectronHeatingConstantRFPower(species, 310, chamber)
    electron_heating = ElectronHeatingConstantAbsorbedPower(species, 320, 1, chamber)
